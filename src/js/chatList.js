...
window.onload = function() {
    ...
    axios.get('http://localhost:8000/api/auth/me', {headers}).then((response) => {
        ...
        if(response.status === 200) {
            ...
            axios.get('http://localhost:8000/api/auth/me/getChatRooms', {headers}).then((chatRoomsResponse) => {
            ...
            axios.get('http://localhost:8000/api/users', {headers}).then((usersResponse) => {
...
function createChatRoom(userSeq) {
    ...
    axios.post('http://localhost:8000/api/chatRooms', data, {headers}).then((response) => {
        if(response.status === 200) {
            if(response.data) {
